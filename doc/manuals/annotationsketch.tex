...
\end{verbatim}
\normalsize
This validator also allows to check the SO types occuring in a GFF3 file against a given OBO ontology file. This checking can be enabled by specifying the file as an argument to the \texttt{-typecheck} switch.
