...
of \(\Substring{p}{i}{m}\) that occurs as a substring in the index. 
If the number
of occurrences of \(\Substring{p}{i}{i+l-1}\) is smaller than the maximum
occurrence parameter \(10\), then all matching statistics positions are 
reported in ascending order of their length.
