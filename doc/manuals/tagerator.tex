...
\Showoptionarg{files} is called a tag.
...
\Showoptionarg{files} against the given index.
...
It can compute the length of the longest prefix of  the  \textit{matching statistics} for each unit. That is, 
