...
design should `look forward' to make such changes unneccessary.
...
\item
For bugfixes for bugs also listed in the \Gt Lighthouse bug tracking web app
(\url{http://genometools.lighthouseapp.com}), commit messages can be used to
update the ticket status. See \url{http://help.lighthouseapp.com/faqs/ticket-workflow/ticket-keyword-updates}
for details.
\end{itemize}
