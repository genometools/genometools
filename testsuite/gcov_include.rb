full_coverage_files = [ "src/core/array.c",
                        ...
                        "src/core/dynalloc.c",
                        "src/core/fasta.c",
                        "src/core/getbasename.c",
			"src/core/interval_tree.c",
                        "src/core/msort.c",
                        "src/core/queue.c",
                        "src/core/string_distri.c",
                        "src/exercise/fragment_overlaps.c",
                        "src/exercise/greedy_assembly.c",
                        "src/exercise/simple_bioseq.c",
                        "src/extended/align.c",
                        ...
                        "src/extended/genome_stream.c",
                        "src/extended/genome_visitor.c",
                        ...
                        "src/extended/linearalign.c",
                        "src/extended/linearedist.c",
                        "src/extended/multilcp.c",
                        "src/extended/shredder.c",
                        "src/extended/splice_site_info_stream.c",
                        "src/extended/splicesiteinfo_visitor.c",
