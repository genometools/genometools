...
if $gttestdata then
  ...
  Keywords "gt_eval"
  Test do
    run_test("#{$bin}gt eval -nuc no #{$testdata}eval/encode_known_genes_Mar07.gff3 #{$gttestdata}eval/complete_result_all_rate_0_minscr_0.95.gff3", :maxtime => 15)
  ...
  Keywords "gt_eval"
  Test do
    run_test("#{$bin}gt eval -nuc no #{$testdata}eval/encode_known_genes_Mar07.gff3 #{$gttestdata}eval/complete_result_all_rate_1_minscr_0.95.gff3", :maxtime => 15)
  ...
  Keywords "gt_eval"
  Test do
    run_test("#{$bin}gt eval -nuc no #{$testdata}eval/encode_known_genes_Mar07.gff3 #{$gttestdata}eval/complete_result_all_rate_3_minscr_0.90.gff3", :maxtime => 15)
  ...
  Keywords "gt_eval"
  Test do
    run_test("#{$bin}gt eval -nuc no #{$testdata}eval/encode_known_genes_Mar07.gff3 #{$gttestdata}eval/complete_result_all_rate_5_minscr_0.90.gff3", :maxtime => 15)
  ...
  Keywords "gt_eval"
  Test do
    run_test("#{$bin}gt eval -nuc no #{$testdata}eval/encode_known_genes_Mar07.gff3 #{$gttestdata}eval/complete_result_all_rate_10_minscr_0.85.gff3", :maxtime => 15)
