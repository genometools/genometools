...
describe.feature("gene", function(gene)
  it("should have transcripts", function()
  ...
  it("should contain all child features within gene coordinates", function()
  ...
  it("should not span a contig separator sequence (100 Ns)", function()
...
describe.region(function(region)
  ...
  it("should start at coordinate 1", function()
...
describe.sequence(function(seq)
  it("should have descriptions starting with organism shorthand", function()
