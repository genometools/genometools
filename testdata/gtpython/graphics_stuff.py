...
if __name__ == "__main__":
  if len(sys.argv) != 3:
    sys.stderr.write("Usage: " + sys.argv[0] + " curve_coords PNG_file\n")
  ...
  g.draw_colored_text(300, 80, Color(1,0,0,0.7), "draw_colored_text")
  g.set_margins(20, 30)
  ...
  g.draw_box(150, 120, 300, 30, Color(0,1,0,0.2), ARROW_LEFT,  20, 2, \
             Color(0,0,0,1), False)
  g.draw_box(150, 170, 300, 20, Color(0,1,1,0.2), ARROW_RIGHT, 20, 1, \
             Color(0,0,0,1), False)
  g.draw_box(150, 210, 300, 20, Color(1,0,0,0.2), ARROW_BOTH,  20, 1, \
             Color(0,0,0,1), False)
  g.draw_box(300, 250,  20, 20, Color(1,0,0,0.2), ARROW_BOTH,  20, 1, \
             Color(0,0,0,1), False)
  g.draw_box(150, 290, 300, 20, Color(1,0,0,0.2), ARROW_NONE,  20, 1, \
             Color(0,0,0,1), False)
  ...
  for line in f:
    ...
    ndata+=1
  g.draw_curve_data(20, 430, Color(0,0,1,.6), data, ndata, Range(0, 1), 40)
