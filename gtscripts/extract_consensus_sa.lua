...
m = Module:new("src/core/error")
m:bare_includes()
m:remove_include("cstr.h")
m:ma2xansi()
p:add(m)

m = Module:new("src/core/range")
m:bare_includes()
...
m = Module:new("src/exercise/sspliced_alignment")
m:bare_includes()
m:remove_include("cstr.h")
m:ma2xansi()
p:add(m)

m = Module:new("src/exercise/sspliced_alignment_parsing")
m:bare_includes()
m:fa2xansi()
p:add(m)
