...
bitPackString8_unit_test(Env *env)
{
...
#ifdef VERBOSE_UNIT_TEST
  fputs("bsStoreUInt8/bsGetUInt8: ", stderr);
#endif /* VERBOSE_UNIT_TEST */
  for (i = 0; i < numRnd; ++i)
  {
#if 8 > 32 && LONG_BIT < 8
  ...
  for (i = 0; i < numRnd; ++i)
  {
    ...
    {
#ifdef VERBOSE_UNIT_TEST
      fprintf(stderr, "Expected %"PRIu8", got %"PRIu8", seed = %lu, i = %lu\n",
...
#endif /* VERBOSE_UNIT_TEST */
  {
    ...
    for (i = 0; i < numRnd; ++i)
    {
      ...
      {
#ifdef VERBOSE_UNIT_TEST
        fprintf(stderr, "Expected %"PRIu8", got %"PRIu8",\n seed = %lu,"
                " i = %lu, bits=%u\n",
...
#ifdef VERBOSE_UNIT_TEST
    fputs("passed\n", stderr);
    fputs("bsStoreUniformUInt8Array/bsGetUniformUInt8Array: ", stderr);
#endif /* VERBOSE_UNIT_TEST */
  ...
  /* int types */
#ifdef VERBOSE_UNIT_TEST
  fputs("bsStoreInt8/bsGetInt8: ", stderr);
#endif /* VERBOSE_UNIT_TEST */  
  for (i = 0; i < numRnd; ++i)
  {
  ...
  for (i = 0; i < numRnd; ++i)
  {
    ...
    {
#ifdef VERBOSE_UNIT_TEST
      fprintf(stderr, "Expected %"PRId8", got %"PRId8",\n"
              "seed = %lu, i = %lu, bits=%u\n",
...
#ifdef VERBOSE_UNIT_TEST
  fputs("passed\n", stderr);
  fputs("bsStoreUniformInt8Array/bsGetInt8: ", stderr);
#endif /* VERBOSE_UNIT_TEST */
  {
...
#ifdef VERBOSE_UNIT_TEST
    fputs("passed\n", stderr);
    fputs("bsStoreUniformInt8Array/bsGetUniformInt8Array: ", stderr);
#endif /* VERBOSE_UNIT_TEST */
