...
typedef ContfindBUstate BUstate_rdjce;
typedef ContfindBUstate BUstate_rdjcv;
typedef struct {} BUinfo_rdjce;
typedef struct {} BUinfo_rdjcv;

static void initBUinfo_rdjcv(GT_UNUSED BUinfo_rdjcv *info,
    GT_UNUSED BUstate_rdjcv *state)
{
  /* nothing to do */
}

static void initBUinfo_rdjce(GT_UNUSED BUinfo_rdjce *info,
    GT_UNUSED BUstate_rdjce *state)
{
  /* nothing to do */
}

static inline void freeBUinfo_rdjcv(GT_UNUSED BUinfo_rdjcv *info,
    GT_UNUSED BUstate_rdjcv *state)
{
  /* nothing to do */
}

static inline void freeBUinfo_rdjce(GT_UNUSED BUinfo_rdjce *info,
    GT_UNUSED BUstate_rdjce *state)
{
  /* nothing to do */
}
...
static inline int processleafedge_rdjcv(GT_UNUSED bool firstsucc,
    ...
    GT_UNUSED BUinfo_rdjcv *father, unsigned long leafnumber,
    BUstate_rdjcv *state, GT_UNUSED GtError *err)
{
...
static inline int processleafedge_rdjce(GT_UNUSED bool firstsucc,
    unsigned long fatherdepth, GT_UNUSED unsigned long fatherlb,
    GT_UNUSED BUinfo_rdjce *father, unsigned long leafnumber,
    BUstate_rdjce *state, GT_UNUSED GtError *err)
{
  unsigned long seqnum;
...
static inline int processbranchingedge_rdjce(GT_UNUSED bool firstsucc,
    ...
    GT_UNUSED BUinfo_rdjce *father, unsigned long sondepth,
    GT_UNUSED unsigned long sonlb, GT_UNUSED unsigned long sonrb,
    GT_UNUSED BUinfo_rdjce *son, BUstate_rdjce *state, GT_UNUSED GtError *err)
{
...
static inline int processbranchingedge_rdjcv(GT_UNUSED bool firstsucc,
    GT_UNUSED unsigned long fatherdepth, GT_UNUSED unsigned long fatherlb,
    GT_UNUSED BUinfo_rdjcv *father, unsigned long sondepth,
    unsigned long sonlb, unsigned long sonrb,
    GT_UNUSED BUinfo_rdjcv *son, BUstate_rdjcv *state, GT_UNUSED GtError *err)
{
...
static int processlcpinterval_rdjcv(GT_UNUSED unsigned long lcp,
    ...
    GT_UNUSED BUinfo_rdjcv *info, GT_UNUSED BUstate_rdjcv *state,
...
static int processlcpinterval_rdjce(GT_UNUSED unsigned long lcp,
    GT_UNUSED unsigned long lb, GT_UNUSED unsigned long rb,
    GT_UNUSED BUinfo_rdjce *info, GT_UNUSED BUstate_rdjce *state,
    GT_UNUSED GtError *err)
{
  return 0;
}

/* generated by scripts/gen-esa-bottomup.sh (v=variable length, e=eqlen) */
