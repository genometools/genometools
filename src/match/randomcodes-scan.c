...
static GtTwobitencoding gt_randomcodes_kmerscan_range(
...
unsigned long gt_randomcodes_kmerscan_eqlen(const GtBitsequence *twobitencoding,
                                           bool withcheck,
                                           ...
                                           void *data)
{
  ...
  if (equallength >= (unsigned long) minmatchlength)
  {
    ...
    {
      encodingsum += (unsigned long) gt_randomcodes_kmerscan_range(
                                                  twobitencoding,
                                                  withcheck,
                                                  kmersize,
                                                  minmatchlength,
...
unsigned long gt_randomcodes_kmerscan(const GtEncseq *encseq,
                                     const GtBitsequence *twobitencoding,
                                     bool withcheck,
                                     unsigned long totallength,
                                     unsigned long numofsequences,
...
void gt_randomcode_runkmerscan(const GtEncseq *encseq,
                              unsigned int mode,
                              unsigned int kmersize,
                              unsigned int minmatchlength)
{
  ...
  if (gt_encseq_accesstype_get(encseq) == GT_ACCESS_TYPE_EQUALLENGTH)
  {
    ...
    encodingsum = gt_randomcodes_kmerscan_eqlen(twobitencoding,
                                               withcheck,
                                               equallength,
                                               totallength,
                                               numofsequences,
  ...
  {
    encodingsum = gt_randomcodes_kmerscan(encseq,
                                         twobitencoding,
                                         withcheck,
                                         totallength,
                                         numofsequences,
