...
match is the last in the chain. A counter for references <refcount>, a
pointer <querymatch>, as well as a variable <chainweight>. */
...
int gt_1d_chainer_calc_chain(GtUword overlap, GtOneDimChainerMatch *chainstart,
                             GtSeedextendMatchIterator *semi, GtError *err);
