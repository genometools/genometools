...
#ifndef CODON_USAGE_SCAN_STREAM_H
#define CODON_USAGE_SCAN_STREAM_H

#include "core/trans_table_api.h"
#include "extended/node_stream_api.h"

/* implements the ``genome stream'' interface */
typedef struct GtCodonUsageScanStream GtCodonUsageScanStream;

const GtNodeStreamClass* gt_codon_usage_scan_stream_class(void);
GtNodeStream*            gt_codon_usage_scan_stream_new(GtNodeStream*);
