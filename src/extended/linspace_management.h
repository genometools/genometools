...
/* Check if enough space is allocated for the two tabs, which are stored in
   ...
   and <vlen>. */
void           gt_linspaceManagement_check_local(GtLinspaceManagement
                                                 *spacemanager,
                                                 GtUword ulen, GtUword vlen,
                                                 size_t valuesize,
                                                 size_t rstabsize);
...
/* Check if enough space to use square space functions in global case is
   ...
   */
bool           gt_linspaceManagement_checksquare(GtLinspaceManagement
                                                 *spacemanager,
                                                 GtUword ulen, GtUword vlen,
                                                 size_t valuesize,
                                                 size_t rsize);
...
/* Check if enough space to use square space functions in local case is
   ...
   timesquarefactor is set, the function checks also the relation with this
   factor and resize the space of <spacemanager> if is it necessary. */
bool           gt_linspaceManagement_checksquare_local(GtLinspaceManagement
                                                       *spacemanager,
                                                       GtUword ulen,
                                                       GtUword vlen,
                                                       size_t valuesize,
...
void           gt_linspaceManagement_set_ulen(GtLinspaceManagement
                                              *spacemanager,
                                              GtUword ulen);
/* Return pointer to valueTab space of the given <spacemanager>. */
void*          gt_linspaceManagement_get_valueTabspace(
...
void*          gt_linspaceManagement_get_crosspointTabspace(
                                                      const GtLinspaceManagement
                                                      *spacemanager);
...
void           gt_linspaceManagement_set_TSfactor(GtLinspaceManagement
                                                  *spacemanager,
