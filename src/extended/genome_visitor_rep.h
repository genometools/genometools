...
struct GenomeVisitorClass {
  ...
  int  (*comment)(GenomeVisitor*, GT_Comment*, GtError*);
  int  (*genome_feature)(GenomeVisitor*, GT_GenomeFeature*, GtError*);
  int  (*sequence_region)(GenomeVisitor*, GT_SequenceRegion*, GtError*);
