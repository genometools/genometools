...
void seqid2file_options(OptionParser *op, GT_Str *seqfile, GT_Str *regionmapping)
{
...
RegionMapping* seqid2file_regionmapping_new(GT_Str *seqfile, GT_Str *regionmapping,
                                            GT_Error *err)
{
  gt_error_check(err);
