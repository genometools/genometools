...
{
  static const GT_GenomeNodeClass gnc = { sizeof (GenomeFeature),
                                       genome_feature_free,
...
GT_GenomeNode* genome_feature_new(Str *seqid, GenomeFeatureType *type, GT_Range range,
                               Strand strand)
{
  GT_GenomeNode *gn;
  GenomeFeature *gf;
...
GT_GenomeNode* genome_feature_new_pseudo(GenomeFeature *gf)
{
  GenomeFeature *pf;
  GT_GenomeNode *pn;
  assert(gf);
