...
GtStr*        gt_genome_node_get_seqid(GT_GenomeNode*);
/* used to sort nodes */
...
bool           gt_genome_node_overlaps_nodes(GT_GenomeNode*, GtArray*);
...
bool           gt_genome_node_overlaps_nodes_mark(GT_GenomeNode*, GtArray*,
                                                  GT_Bittab*);
