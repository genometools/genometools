...
/*read NREcnseq from disc. Temporary needs original encseq for development
  purposes*/
GtNREncseq *gt_n_r_encseq_read_nre(const char *basename_nre,
                                   const GtEncseq *orig_es,
                                   GtError *err);

/*write NREncseq <nre> to filepointer <fp>*/
void        gt_n_r_encseq_write_nre(GtNREncseq *nre, FILE* fp);

/*prints statistical info of <nrencseq>*/
