...
bool          genome_node_has_children(Genome_node*);
bool          genome_node_direct_children_do_not_overlap(Genome_node*);
...
bool          genome_node_overlaps_nodes(Genome_node*, Array*);
...
bool          genome_node_overlaps_nodes_mark(Genome_node*, Array*, Bittab*);
