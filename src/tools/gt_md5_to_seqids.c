...
static void *gt_md5_to_seqids_arguments_new(void)
{
...
static void gt_md5_to_seqids_arguments_delete(void *tool_arguments)
{
...
static GtOptionParser* gt_md5_to_seqids_option_parser_new(void *tool_arguments)
{
  MD5ToSeqidsArguments *arguments = tool_arguments;
  GtOptionParser *op;
  GtOption *option;
...
static int gt_md5_to_seqids_runner(GT_UNUSED int argc, const char **argv,
...
GtTool *gt_md5_to_seqids(void)
{
  return gt_tool_new(gt_md5_to_seqids_arguments_new,
                     gt_md5_to_seqids_arguments_delete,
                     gt_md5_to_seqids_option_parser_new,
                     NULL,
                     gt_md5_to_seqids_runner);
}
