...
typedef struct CanvasCairoFile CanvasCairoFile;
...
Canvas* canvas_cairo_file_new(Style *style, GraphicsOutType output_type,
                              unsigned long width, ImageInfo *image_info);
/* Write rendered <canvas> to file with name <filename>. */
int     canvas_cairo_file_to_file(CanvasCairoFile *canvas,
