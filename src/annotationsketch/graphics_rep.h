...
struct GraphicsClass {
  ...
  void    (*draw_colored_text)(Graphics*, double, double, Color, const char*);
  ...
  void    (*draw_vertical_line)(Graphics*, double, double, Color, double);
  void    (*draw_box)(Graphics*, double, double, double, double, Color,
                      ArrowStatus, double, double, Color, bool);
  ...
  void    (*draw_caret)(Graphics*, double, double, double, double, ArrowStatus,
                        double, double, Color);
  void    (*draw_rectangle)(Graphics*, double, double, bool, Color, bool,
                                  Color, double, double);
  void    (*draw_arrowhead)(Graphics*, double, double, Color, ArrowStatus);
  int     (*save_to_file)(const Graphics*, const char*, Error*);
  void    (*save_to_stream)(const Graphics*, Str*);
  void    (*free)(Graphics*);
};
