...
checkerror "../bin/gt ltrharvest -index ${LTR}/gt_ltr/s_cer_tab/chr02_tab/chr02.fsa -seed 100 -minlenltr 100 -maxlenltr 1000 -mindistltr 1500 -maxdistltr 15000 -similar 80 -mintsd 5 -maxtsd 20 -motif tgca -motifmis 0 -vic 60 -overlaps best -xdrop 5 -mat 2 -mis -3 -ins -3 -del -3 -v"
